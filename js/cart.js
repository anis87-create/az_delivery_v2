...
const displayCartCount = () => {
  ...
  const count = document.createTextNode('1');
  notificationDiv.appendChild(count);
  document.getElementById('cart').appendChild(notificationDiv);
  notificationDiv.style.position='absolute';
  notificationDiv.style.top ='-5px';
  notificationDiv.style.right ='1px';
  ...
  notificationDiv.style.background='#22C55E';
